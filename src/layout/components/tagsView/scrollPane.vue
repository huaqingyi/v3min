<!--
 * @FilePath: /vue3-template/src/layout/components/tagsView/scrollPane.vue
 * @Descripttion: 
 * @version: 
 * @Author: 易华青
 * @Date: 2020-12-22 17:27:10
 * @LastEditors: huaqingyi
 * @LastEditTime: 2020-12-23 12:07:42
 * @debugger: 
-->
<template>
    <el-scrollbar
...
export default class extends Vue {
    ...
    public moveToTarget(currentTag: HTMLElement) {
        ...
        const scrollWrapper = scrollContainer.$refs.wrap as HTMLElement;
        const tagList = ((this.$parent || {} as any).refs || {}).tags as any[];
